...
public interface Dao<T, ID> extends CloseableIterable<T> {
     ...
     * <p/>
     * <p>
     * <b>WARNING</b>: because the {@link java.util.Iterator#hasNext()}, {@link java.util.Iterator#next()}, etc. methods can only throw
     ...
     * {@link java.lang.ref.WeakReference}) referenced by the DAO. No support for objects returned by the {@link #queryRaw} methods.
     *
     ...
     * allows you to use a {@link ReferenceObjectCache} with {@link java.lang.ref.SoftReference} setting, the {@link LruObjectCache},
