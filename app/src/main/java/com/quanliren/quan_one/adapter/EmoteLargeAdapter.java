...
public class EmoteLargeAdapter extends ParentsAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (name.getGiffile() != null && !name.getGiffile().equals("")) {
            ImageLoader.getInstance().displayImage(Util.FILE + name.getPngfile(), holder.mIvImage, ac.options_defalut_face);
        } else {
            ImageLoader.getInstance().displayImage(name.getPngUrl(), holder.mIvImage, ac.options_defalut_face);
        }
