...
public class NearPeopleGridAdapter extends BaseAdapter<User> {

    public NearPeopleGridAdapter(Context context) {
        super(context);
    }
    ...
    public int getConvertView(int position) {
        return R.layout.near_people_grid_item;
    }
    ...
    class ViewHolder extends BaseHolder<User> {
        ...
        public void bind(User user, int position) {
            ...
            vip_is.setVisibility(View.GONE);
            ...
            if (user.getIsvip() == 2) {
                vip_is.setVisibility(View.VISIBLE);
                vip_is.setImageResource(R.drawable.rish_vip_en);
            } else if (user.getIsvip() == 1) {
                vip_is.setVisibility(View.VISIBLE);
                vip_is.setImageResource(R.drawable.common_vip_en);
            } else {
                vip_is.setVisibility(View.GONE);
            }
