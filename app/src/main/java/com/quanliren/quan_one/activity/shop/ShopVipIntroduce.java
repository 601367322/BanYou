...
public class ShopVipIntroduce extends BaseActivity {
	...
	public void init() {
		...
		list.add(new VipIntroduceBean("可以查看其他用户联系方式", R.drawable.vip_intro_13));
		list.add(new VipIntroduceBean("看认证视频", R.drawable.vip_intro_12));
		list.add(new VipIntroduceBean("给TA发消息", R.drawable.vip_intro_7));
		list.add(new VipIntroduceBean("可以查看聊天高清图片、语音、视频", R.drawable.vip_intro_1));
		...
		list.add(new VipIntroduceBean("普通会员可最多创建20人群\n富豪会员可最多创建50人群", R.drawable.vip_intro_11));
